...
public class StreamFlatMap {
    public static void main(String[] args) {
        try {
            long noOfWords = Files.lines(Paths.get("C:\\Users\\qfjis\\Downloads\\FromOleksandr\\new.txt"))
        ...
        try {
            List<String> uniqueWords = Files.lines(Paths.get("C:\\Users\\qfjis\\Downloads\\FromOleksandr\\new.txt"))
